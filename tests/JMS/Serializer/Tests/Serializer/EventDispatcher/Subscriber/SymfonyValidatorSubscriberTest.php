...
class SymfonyValidatorSubscriberTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testValidate()
    {
        ...
        $this->subscriber->onPostDeserialize(new PostSerializeEvent($context, $obj, array()));
    }
    ...
    public function testValidatorIsNotCalledWhenNoGroupsAreSet()
    {
        ...
        $this->subscriber->onPostDeserialize(new PostSerializeEvent(DeserializationContext::create(), new \stdClass, array()));
    }
