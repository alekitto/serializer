...
namespace Kcs\Serializer\Adapter\Symfony {
    ...
    use Symfony\Component\Messenger\Transport\Serialization\SerializerInterface as SerializationInterface;
    use Symfony\Component\Messenger\Transport\Serialization\SerializerConfiguration;

    class MessengerSerializer implements SerializationInterface
    {
        /**
